// Military power data
// Military spending in billions USD (2023 estimates), nuclear status
...
export const militaryData = {
  ...
  PRK: {
    ...
    nuclear: true,
    nukes: 30,
    activePersonnel: 1190000,
    region: 'Asia'
  },
  
  // Major conventional militaries
  BRA: {
    spending: 35,
    nuclear: false,
    activePersonnel: 192000,
    region: 'Americas'
  },
  CAN: {
    spending: 26,
  ...
  ITA: {
    spending: 34,
    nuclear: false,
    activePersonnel: 130000,
    region: 'Europe'
  },
  ESP: {
    spending: 17,
    nuclear: false,
    activePersonnel: 93000,
    region: 'Europe'
  },
  POL: {
    spending: 17,
  ...
  NLD: {
    spending: 17,
    nuclear: false,
    activePersonnel: 41000,
    region: 'Europe'
  },
  SVE: {
    spending: 7.6,
    nuclear: false,
    activePersonnel: 8000,
    region: 'Europe'
  },
  NOR: {
    spending: 8,
  ...
  ZAF: {
    spending: 5,
    nuclear: false,
    activePersonnel: 88000,
    region: 'Africa'
  },
  EGY: {
    spending: 13,
    nuclear: false,
    activePersonnel: 438000,
    region: 'Africa/Middle East'
  },
  NGA: {
    spending: 3,
    nuclear: false,
    activePersonnel: 118000,
    region: 'Africa'
  }
}
