...
// Format: { id, name, claimants: [cca3...], location: [lat, lng], status, description }

export const territorialDisputes = [
  {
    id: 'palestine',
  ...
  },
  {
    ...
    status: 'active',
    severity: 'high',
    description: 'Eastern Ladakh border clashes 2020, 2022. Aksal Chin (Ladakh) claimed by China. India considers Aksai Chin its territory. Rising military tensions.',
    since: 1962
  },
  {
    id: 'arunachal',
  ...
  {
    id: 'moroccan-sahara',
    name: 'Northern Morocco (Rifain Independence)',
    claimants: ['MAR', 'RIF'],
    location: [35.3, -4.0],
    status: 'dormant',
    severity: 'low',
    description: 'Riff/Rifain autonomy/independence movement. Low-level tensions. Cultural/linguistic identity within Morocco.',
    since: 1921
  }
]

export const recentConflicts = [
  {
    name: 'Ukraine War',
    location: [49.0, 31.0],
    start: 2022,
  ...
  },
  {
    ...
    start: 2015,
    status: 'ongoing',
    description: 'Saudi-UAE vs Houthis (Iran-backed). Humanitarian catastrophe. Regional proxy war. Largely forgotten by media.'
  },
  {
    ...
    start: 2011,
    status: 'ceasefire',
    description: 'Assad regime vs rebels. Russia intervened 2015. Chemical weapons use. Regional intervention (Turkey, Israel, US).'
  },
  {
