...
const REGIONAL_POWERS = {
  ...
  'East Asia': {
    ...
    keyPlayers: [
      ...
      { cca3: 'JPN', status: 'major', power: 80, description: 'Advanced economy, US ally, military buildup' },
...
function generateFile(regionalPowers) {
  const content = `// Auto-generated from public data sources
// Sources: World Bank GDP, SIPRI military spending, international relations analysis, UCDP
// Updated: ${new Date().toISOString()}

export const regionalPowers = ${JSON.stringify(regionalPowers, null, 2)}
...
`;
  ...
  fs.writeFileSync('./src/data/regionalPowers.js', content);
  console.log('✓ Generated regionalPowers.js with World Bank, SIPRI, and IR analysis');
}

generateFile(REGIONAL_POWERS);
